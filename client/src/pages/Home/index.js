...
function Home() {
  ...
  return (
    <div>
      <PageTitle
        title={`Hello ${user.firstName} ${user.lastName}, welcome to the VersaMart Pay`}
      />
      <div className="bg-tertiary p-2 mt-2 w-50 br-3 flex-col gap-1 uppercase">
        ...
        <div className="flex justify-between">
          <h1 className="text-md text-white">Unités</h1>
          <h1 className="text-md text-white"> {user.units || 0} unités</h1>
        </div>
      </div>

      <div className="card p-2 mt-2 w-50 br-3 flex-col gap-1">
        <div className="flex justify-between">
